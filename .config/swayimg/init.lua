...
swayimg.viewer.on_key("Delete", function() delete("viewer") end)
swayimg.viewer.on_key("Ctrl-d", function() delete("viewer") end)
...
swayimg.gallery.on_key("Delete", function() delete("gallery") end)
swayimg.gallery.on_key("Ctrl-d", function() delete("gallery") end)
